 ...
 *                                                  *
 ****************************************************/
#ifndef _MY_CAMERA_VARIBLE_H_
#define _MY_CAMERA_VARIBLE_H_

#include "stm32f10x.h"
#include "cam_cfg.h"	/* 获取摄像头的时钟分频数 */
...
const u8 ov2640_jpeg_init[][2]=
{
  ...
  0xff, 0x01,
  0x3c, 0x32,
  0x11, CAMERA_CLK_DIV,	/* 此处设置时钟分频，0x3f为最大分频 */
  0x09, 0x02,
  0x04, 0x28,
  0x13, 0xe5,
  0x14, 0x48,
  ...
  0xc8, 0x08,
  0xc9, 0x80,
  0x7c, 0x00,	/* 注意，通过0x7c、0x7d两个寄存器能间接访问一些隐藏的寄存器 */
  0x7d, 0x00,	/* 下面的一些配置拍照效果的函数，都是这样做的 */
  0x7c, 0x03,	/* 但这些寄存器数据手册上都没有说明 */
  0x7d, 0x48,
  0x7d, 0x48,	/* 到此配完一组 */
  0x7c, 0x08,
  0x7d, 0x20,
